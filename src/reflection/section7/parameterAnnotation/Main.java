package reflection.section7.parameterAnnotation;

import reflection.section7.parameterAnnotation.annotations.Annotations.*;
...
public class Main {
    ...
    public static void main(String[] args) throws InvocationTargetException, IllegalAccessException {
        bestGames();
        bestGamesUsingAnnotations();
        sqlQueryBuilder();
    }

    public static void bestGames(){
    ...
    public static void bestGamesUsingAnnotations(){
        try {
            BestGamesFinder bestGamesFinder = new BestGamesFinder();
    ...
    public static void sqlQueryBuilder(){
        ...
        try {
            sqlQuery = execute(sqlQueryBuilder);
        } catch (InvocationTargetException | IllegalAccessException e) {
            throw new RuntimeException(e);
        }
