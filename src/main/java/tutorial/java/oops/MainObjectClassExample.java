...
public class MainObjectClassExample {
    public static void main(String[] args)
    {
        ...
        // Get the same hash code for two objects as they are referencing to same
        System.out.println("book1 hash code: "
                + book1.hashCode());
        System.out.println("book2 hash code: "
                + book2.hashCode());

        // Set book1 to null and trigger garbage collection
        // to call finalize method
        book1 = null;
        System.gc();
    }
}
