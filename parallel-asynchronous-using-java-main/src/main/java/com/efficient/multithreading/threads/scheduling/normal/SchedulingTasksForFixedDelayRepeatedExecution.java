...
/**
 *  Execute scheduled tasks repeatedly with a fixed delay between execution.
 *  Always create another timer instance to run separate thread or long running tasks.
 * */
public class SchedulingTasksForFixedDelayRepeatedExecution {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        timer.schedule(new ScheduledTaskA(1000), scheduledTime, intervalInMillis);
